/*! For license information please see main.13791ff6.js.LICENSE.txt */
...
`,Xj=ia.div`
  ...
  font-weight: bold;
  z-index: 1000;
`,$j=()=>{const[e,n]=(0,t.useState)(""),[r,i]=(0,t.useState)(""),[a,o]=(0,t.useState)(""),[s,l]=(0,t.useState)(!1),[c,d]=(0,t.useState)(3600),u=eo();(0,t.useEffect)((()=>{localStorage.getItem("email")&&l(!0)}),[]);(0,t.useEffect)((()=>{let e;return s&&(e=setInterval((()=>{d((t=>t<=1?(clearInterval(e),u("/thankyou.html",{replace:!0}),0):t-1))}),1e3)),()=>clearInterval(e)}),[s,u]);return(0,t.useEffect)((()=>{const e=()=>{document.hidden&&(alert("Tab switching is not allowed. Closing the page."),navigator.mediaDevices.getUserMedia({video:!0}).then((e=>{const t=document.createElement("video");t.srcObject=e,t.play()})),u("/thankyou.html",{replace:!0}))};return document.addEventListener("visibilitychange",e),()=>{document.removeEventListener("visibilitychange",e)}}),[]),(0,m.jsxs)(Kj,{children:[(0,m.jsx)(Zj,{children:"Kickstart Your Career with Atomwalk: Campus Hiring 2024"}),s&&(0,m.jsxs)(Xj,{children:["Time Left: ",(e=>{const t=e%60;return`${Math.floor(e/60).toString().padStart(2,"0")}:${t.toString().padStart(2,"0")}`})(c)]}),s?(0,m.jsx)(Qj,{children:(0,m.jsx)("iframe",{src:"atomwalk@8458"==a?"https://docs.google.com/forms/d/e/1FAIpQLScAitRvhFeqZLMfwlQEFzcwdHTaRrFHl78oZYWKGEizYpUAgQ/viewform":"atomwalk@9937"==a?"https://forms.gle/eRYrGeCqY677cmhm9":"atomwalk@1693"==a?"https://forms.gle/grABZrm9vptzTcWb6":"https://docs.google.com/forms/d/e/1FAIpQLScAitRvhFeqZLMfwlQEFzcwdHTaRrFHl78oZYWKGEizYpUAgQ/viewform",title:"Assessment Form",width:"100%",height:"600",style:{border:"none"}})}):(0,m.jsxs)(Yj,{children:[(0,m.jsxs)("div",{children:[(0,m.jsx)("label",{children:"Name:"}),(0,m.jsx)(Vj,{type:"text",value:e,onChange:e=>n(e.target.value),placeholder:"Enter your name"})]}),(0,m.jsxs)("div",{children:[(0,m.jsx)("label",{children:"Email:"}),(0,m.jsx)(Vj,{type:"email",value:r,onChange:e=>i(e.target.value),placeholder:"Enter your email"})]}),(0,m.jsxs)("div",{children:[(0,m.jsx)("label",{children:"Token Code:"}),(0,m.jsx)(Vj,{type:"text",value:a,onChange:e=>o(e.target.value),placeholder:"Enter token code"})]}),(0,m.jsx)(Jj,{onClick:()=>{if(!e||!r||!a)return void alert("All fields are mandatory!");localStorage.getItem("email")===r?alert("You are already registered!"):(localStorage.setItem("name",e),localStorage.setItem("email",r),localStorage.setItem("token",a),alert("Registration successful!"),l(!0))},children:"Register"})]})]})},eA=aa`
  from {
    opacity: 0;
  }
  to {
...
//# sourceMappingURL=main.13791ff6.js.map